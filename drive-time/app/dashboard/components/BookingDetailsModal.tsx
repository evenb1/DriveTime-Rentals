  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 p-4">
      <div className="bg-white w-full max-w-lg rounded-lg shadow-lg p-6 relative">
        ...
        {/* Car Name & Price */}
        <div className="">
          <h2 className="text-2xl font-semibold text-center text-gray-800 mb-2">{carName}</h2>
          <p className="text-gray-600 text-lg font-semibold flex items-center justify-start">
        ...
        <div className="mt-2 justify-start">
          <p className="text-gray-700 flex items-center">
            ...
            <span className="font-bold">Rental Period: </span> {new Date(booking.start_date).toLocaleDateString()} - {new Date(booking.end_date).toLocaleDateString()}
          </p>
        </div>
        ...
        <div className="mt-4">
          {booking.status === "confirmed" ? (
            ...
            <span className="flex items-center justify-center gap-2 text-yellow-600 text-lg">
             Status: <FaClock className="text-yellow-500" /> Pending
            </span>
          ) : (
