...
const AddressSection: React.FC = () => {
    return (
      <section className="py-10 pb-20 px-4 bg-gray-50">
        ...
        <div className="flex flex-row max-sm:flex-col max-sm:gap-5 max-sm:items-center justify-center">
  {/* Location Section */}
  <FaLocationDot className="justify-center ml-20 max-sm:ml-0 text-5xl" />
  <div className="flex flex-col font-extralight px-5 text-xl max-sm:items-center max-sm:text-center">
    <h2 className="text-slate-900">Ole Dume Road</h2>
    <h2 className="text-slate-900">Nairobi, Kenya</h2>
  </div>

  {/* Contact Section */}
  <FaHeadphones className="justify-center ml-20 max-sm:ml-0 text-5xl" />
  <div className="flex flex-col font-extralight px-5 text-xl max-sm:items-center max-sm:text-center">
  ...
  <FaClock className="justify-center ml-20 max-sm:ml-0 text-5xl" />
  <div className="flex flex-col font-extralight px-5 text-xl max-sm:items-center max-sm:text-center">
