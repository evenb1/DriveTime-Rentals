...
const GlassNavbar: React.FC = () => {
    ...
    return (
        <>
            <nav className="flex items-center justify-between max-sm:rounded-none px-4 md:px-10 py-3 mx-4 md:mx-9 my-5 bg-white bg-opacity-70 backdrop-blur-md  shadow-lg relative">
